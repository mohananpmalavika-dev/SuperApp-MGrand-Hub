...
const menuItems = [
  ...
  { text: 'AI Tutor', icon: <Chat />, path: '/education/tutor' },
  { text: 'Progress', icon: <TrendingUp />, path: '/education/progress' },
  { text: 'Study Plan', icon: <CalendarToday />, path: '/education/study-plan' },
  { text: 'Subscription', icon: <CardMembership />, path: '/education/subscription' },
];
...
const EducationLayout = ({ children }) => {
  ...
  const drawer = (
    <Box>
      ...
      {/* Streak Badge */}
      <Box p={2} bgcolor="primary.light" m={2} borderRadius={2}>
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      >
        <Toolbar>
          ...
          >
            <MenuItem onClick={() => { handleMenuClose(); navigate('/education/profile'); }}>
              <ListItemIcon>
                <Person fontSize="small" />
              </ListItemIcon>
              <ListItemText>Profile</ListItemText>
            </MenuItem>
            <MenuItem onClick={() => { handleMenuClose(); navigate('/education/settings'); }}>
              <ListItemIcon>
